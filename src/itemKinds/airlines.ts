...
export const AIRLINES: readonly AirlineSpec[] = [
  // ─── United States ──────────────────────────────────────────────────────
  {
    ...
    aliases: ['american', 'american airlines', 'aa'],
    checkInWindowHours: 24,
  },
  {
    iata: 'DL',
    display: 'Delta',
    aliases: ['delta', 'delta air lines', 'dl'],
    checkInWindowHours: 24,
  },
  {
    iata: 'UA',
    display: 'United',
    aliases: ['united', 'united airlines', 'ua'],
    checkInWindowHours: 24,
  },
  {
    iata: 'WN',
    display: 'Southwest',
    aliases: ['southwest', 'southwest airlines', 'wn'],
    checkInWindowHours: 24,
  },
  {
    iata: 'B6',
    display: 'JetBlue',
    aliases: ['jetblue', 'jet blue', 'b6'],
    checkInWindowHours: 24,
  },
  {
    iata: 'AS',
    display: 'Alaska',
    aliases: ['alaska', 'alaska airlines', 'as'],
    checkInWindowHours: 24,
  },
  {
    iata: 'NK',
    display: 'Spirit',
    aliases: ['spirit', 'spirit airlines', 'nk'],
    checkInWindowHours: 24,
  },
  {
    iata: 'F9',
    display: 'Frontier',
    aliases: ['frontier', 'frontier airlines', 'f9'],
    checkInWindowHours: 24,
  },
  {
    iata: 'HA',
    display: 'Hawaiian',
    aliases: ['hawaiian', 'hawaiian airlines', 'ha'],
    checkInWindowHours: 24,
  },
  {
    iata: 'G4',
    display: 'Allegiant',
    aliases: ['allegiant', 'allegiant air', 'g4'],
    checkInWindowHours: 24,
  },
  // ─── Canada / Mexico / Latin America ─────────────────────────────────
  {
    iata: 'AC',
    display: 'Air Canada',
    aliases: ['air canada', 'aircanada', 'ac'],
    checkInWindowHours: 24,
  },
  {
    iata: 'WS',
    display: 'WestJet',
    aliases: ['westjet', 'west jet', 'ws'],
    checkInWindowHours: 24,
  },
  {
    iata: 'AM',
    display: 'Aeromexico',
    aliases: ['aeromexico', 'aero mexico', 'am'],
    checkInWindowHours: 48,
  },
  {
    iata: 'LA',
    display: 'LATAM',
    aliases: ['latam', 'latam airlines', 'la'],
    checkInWindowHours: 48,
  },
  ...
  { iata: 'CM', display: 'Copa', aliases: ['copa', 'copa airlines', 'cm'], checkInWindowHours: 24 },
  {
    iata: 'G3',
    display: 'Gol',
    aliases: ['gol', 'gol linhas aereas', 'g3'],
    checkInWindowHours: 48,
  },
  {
    iata: 'JJ',
    display: 'LATAM Brasil',
    aliases: ['latam brasil', 'tam', 'jj'],
    checkInWindowHours: 48,
  },
  // ─── Europe ─────────────────────────────────────────────────────────
  {
    ...
    aliases: ['british airways', 'british', 'ba'],
    checkInWindowHours: 24,
  },
  { iata: 'LH', display: 'Lufthansa', aliases: ['lufthansa', 'lh'], checkInWindowHours: 23 },
  {
    iata: 'AF',
    display: 'Air France',
    aliases: ['air france', 'airfrance', 'af'],
    checkInWindowHours: 30,
  },
  ...
  { iata: 'AY', display: 'Finnair', aliases: ['finnair', 'ay'], checkInWindowHours: 36 },
  {
    iata: 'SK',
    display: 'SAS',
    aliases: ['sas', 'scandinavian airlines', 'sk'],
    checkInWindowHours: 22,
  },
  {
    iata: 'TP',
    display: 'TAP Portugal',
    aliases: ['tap', 'tap portugal', 'tap air portugal', 'tp'],
    checkInWindowHours: 36,
  },
  {
    iata: 'LX',
    display: 'Swiss',
    aliases: ['swiss', 'swiss international', 'lx'],
    checkInWindowHours: 23,
  },
  {
    iata: 'OS',
    display: 'Austrian',
    aliases: ['austrian', 'austrian airlines', 'os'],
    checkInWindowHours: 23,
  },
  {
    iata: 'SN',
    display: 'Brussels Airlines',
    aliases: ['brussels', 'brussels airlines', 'sn'],
    checkInWindowHours: 24,
  },
  { iata: 'EI', display: 'Aer Lingus', aliases: ['aer lingus', 'ei'], checkInWindowHours: 30 },
  {
    ...
    aliases: ['virgin atlantic', 'vs'],
    checkInWindowHours: 24,
  },
  {
    iata: 'AZ',
    display: 'ITA Airways',
    aliases: ['ita', 'ita airways', 'alitalia', 'az'],
    checkInWindowHours: 24,
  },
  {
    iata: 'TK',
    display: 'Turkish Airlines',
    aliases: ['turkish', 'turkish airlines', 'tk'],
    checkInWindowHours: 24,
  },
  { iata: 'FR', display: 'Ryanair', aliases: ['ryanair', 'fr'], checkInWindowHours: 48 },
  {
    iata: 'U2',
    display: 'easyJet',
    aliases: ['easyjet', 'easy jet', 'u2'],
    checkInWindowHours: 30 * 24,
  },
  { iata: 'W6', display: 'Wizz Air', aliases: ['wizz', 'wizz air', 'w6'], checkInWindowHours: 48 },
  {
    iata: 'DY',
    display: 'Norwegian',
    aliases: ['norwegian', 'norwegian air', 'dy'],
    checkInWindowHours: 24,
  },
  ...
  { iata: 'EK', display: 'Emirates', aliases: ['emirates', 'ek'], checkInWindowHours: 48 },
  {
    iata: 'EY',
    display: 'Etihad',
    aliases: ['etihad', 'etihad airways', 'ey'],
    checkInWindowHours: 30,
  },
  {
    iata: 'QR',
  ...
  { iata: 'GF', display: 'Gulf Air', aliases: ['gulf air', 'gf'], checkInWindowHours: 24 },
  {
    iata: 'SV',
    display: 'Saudia',
    aliases: ['saudia', 'saudi arabian', 'sv'],
    checkInWindowHours: 24,
  },
  // ─── Asia / Pacific ─────────────────────────────────────────────────
  {
    iata: 'NH',
    display: 'ANA',
    aliases: ['ana', 'all nippon', 'all nippon airways', 'nh'],
    checkInWindowHours: 24,
  },
  { iata: 'JL', display: 'JAL', aliases: ['jal', 'japan airlines', 'jl'], checkInWindowHours: 24 },
  {
    iata: 'CX',
    display: 'Cathay Pacific',
    aliases: ['cathay', 'cathay pacific', 'cx'],
    checkInWindowHours: 48,
  },
  {
    iata: 'SQ',
    display: 'Singapore Airlines',
    aliases: ['singapore', 'singapore airlines', 'sq'],
    checkInWindowHours: 48,
  },
  {
    iata: 'KE',
    display: 'Korean Air',
    aliases: ['korean air', 'korean', 'ke'],
    checkInWindowHours: 48,
  },
  {
    iata: 'OZ',
    display: 'Asiana',
    aliases: ['asiana', 'asiana airlines', 'oz'],
    checkInWindowHours: 48,
  },
  ...
  {
    iata: 'TG',
    display: 'Thai Airways',
    aliases: ['thai', 'thai airways', 'tg'],
    checkInWindowHours: 24,
  },
  {
    iata: 'MH',
    display: 'Malaysia Airlines',
    aliases: ['malaysia airlines', 'malaysia', 'mh'],
    checkInWindowHours: 48,
  },
  {
    iata: 'PR',
    display: 'Philippine Airlines',
    aliases: ['philippine', 'philippine airlines', 'pr'],
    checkInWindowHours: 24,
  },
  {
    iata: 'GA',
    display: 'Garuda',
    aliases: ['garuda', 'garuda indonesia', 'ga'],
    checkInWindowHours: 24,
  },
  {
    iata: 'VN',
    display: 'Vietnam Airlines',
    aliases: ['vietnam airlines', 'vn'],
    checkInWindowHours: 24,
  },
  ...
  {
    iata: 'VA',
    display: 'Virgin Australia',
    aliases: ['virgin australia', 'va'],
    checkInWindowHours: 24,
  },
  {
    iata: 'NZ',
    display: 'Air New Zealand',
    aliases: ['air new zealand', 'air nz', 'nz'],
    checkInWindowHours: 48,
  },
  { iata: 'JQ', display: 'Jetstar', aliases: ['jetstar', 'jq'], checkInWindowHours: 48 },
  {
    iata: 'TL',
    display: 'Airnorth',
    aliases: ['airnorth', 'air north', 'tl'],
    checkInWindowHours: 24,
  },
  {
    iata: 'ZL',
    display: 'Rex',
    aliases: ['rex', 'regional express', 'zl'],
    checkInWindowHours: 24,
  },
  ...
  // ─── Africa ─────────────────────────────────────────────────────────
  {
    ...
    aliases: ['south african', 'south african airways', 'sa'],
    checkInWindowHours: 24,
  },
  {
    iata: 'ET',
    display: 'Ethiopian',
    aliases: ['ethiopian', 'ethiopian airlines', 'et'],
    checkInWindowHours: 24,
  },
  {
    iata: 'KQ',
    display: 'Kenya Airways',
...
export function formatFlightNumber(
  ...
  const digitMatch = /(\d{1,5})\s*$/.exec(raw);
  ...
  const prefixMatch = /^([A-Za-z0-9]{1,3})/.exec(raw);
  const code =
    normalizeAirlineCode(airline) ?? (prefixMatch ? normalizeAirlineCode(prefixMatch[1]) : null);
